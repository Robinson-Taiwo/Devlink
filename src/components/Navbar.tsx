...
const Navbar: React.FC = () => {
    ...
    return (
        <div className=" phone:w-[27.92rem] tablet:w-[56.67rem] sphone:w-[100%] items-center   flex flex-row ">
            ...
            <div className=" flex flex-row  ">
                <div
                    className={`  ${activeTab === "links" ? "bg-[#EFEBFF] text-purple " : ""
                        }   sphone:w-[6.17rem] phone:w-[6.17rem] tablet:w-[10.17rem] flex-row gap-[0.67rem]  h-[3.5rem] rounded-[0.67rem] flex items-center justify-center  `}
                ...
                <div
                    className={`  ${activeTab === "profile" ? "bg-[#EFEBFF]" : ""
                        }   sphone:w-[6.17rem] phone:w-[6.17rem]  tablet:w-[15.58rem] h-[3.5rem] flex-row gap-[0.67rem] rounded-[0.67rem] flex items-center justify-center `}
            ...
            <div className="sphone:ml-[3.458rem] phone:ml-[3.458rem] tablet:ml-[4.625rem] sphone:w-[4.33rem] phone:w-[4.33rem] tablet:w-[9.5rem]  h-[3.5rem] border-purple border flex items-center justify-center rounded-[0.67rem] ">
